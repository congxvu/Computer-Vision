    ...
    \begin{frame}[t]
        ...
        \begin{normalsize}
            \begin{itemize}
                ...
                \item[]{\selectfont\textcolor{blue}{\input{yourAnswers/6a.tex}}}
    ...
    \begin{frame}[t]
        ...
        \begin{normalsize}
            \begin{itemize}
                ...
                \item[]{\selectfont\textcolor{blue}{\input{yourAnswers/6b.tex}}}
    ...
    \begin{frame}[t]
        ...
        \begin{normalsize}
            \begin{itemize}
                ...
                \item[]{\selectfont\textcolor{blue}{\input{yourAnswers/6c.tex}}}
