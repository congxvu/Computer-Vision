...
def main():
    ...
    # save it to local image
    #cv2.imwrite('C:/Users/congx/OneDrive/Documents/PS1-master/pics/ps1-4-d-1.png', diff_green)
    cv2.imwrite(os.path.join(path ,'ps1-4-d-1.png'), diff_green)
    ...
    # save it to local image
    #cv2.imwrite('C:/Users/congx/OneDrive/Documents/PS1-master/pics/ps1-4-d-1.png', diff_green)
    cv2.imwrite(os.path.join(path ,'ps1-5-a-1.png'), noisy_green)
    ...
    # code to show hybrid image _ Cong
    cv2.imshow('hybrid_image Q7', hybrid_image)
    cv2.waitKey(0)
